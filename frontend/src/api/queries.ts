...
const mockTasks: any[] = [
  {
    ...
    comments: [
      { id: 'c_1', content: 'The SVG bezier path rendering looks super clean!', author: { name: 'Alex Rivera' }, createdAt: new Date().toISOString() },
    ],
  },
  {
    id: 't_11',
  ...
  },
  {
    ...
    priority: 'URGENT',
    statusId: 'st_review',
    status: { id: 'st_review', name: 'Code Review', category: 'IN_REVIEW', color: '#f59e0b' },
    sprintId: 'sp_24',
    storyPoints: 8,
    order: 3,
